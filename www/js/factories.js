...
// Cria um objeto com informações sobre o tempo/clima de um dia a partir de dados vindos da API
.factory('WeatherFactory', function() {
	// Informações sobre os icones da previsão do tempo
	var IconInfo = {
	...
	var getWeatherType = function(weatherString) {
		var result;
		switch(weatherString) {
			case "Rain":
			case "Drizzle":	result = IconInfo.rainy; break;

			case "Mist":
			case "Clouds": result = IconInfo.cloudy; break;

			case "Clear":
			default: result = IconInfo.clear; break;
		}
		return result;
	}

	return function(data, isToday = false) {
		var dayLabel = "Hoje";
